...
public class JavaScriptUtil {
	...
	public static void flash(WebElement element, WebDriver driver) {
		...
		String bgcolor = element.getCssValue("backgroundColor");//blue type javascript code
		for (int i = 0; i < 20; i++) {
	...
	public static void sendKeysUsingJSWithClassName(WebDriver driver, By zipcode, String value){
		JavascriptExecutor js = ((JavascriptExecutor) driver);
		js.executeScript("document.getElementsByClassName('" + zipcode + "').value='"+value+"'");
	}
